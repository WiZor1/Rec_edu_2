...
class MainRecommender:
    ...
    def __init__(self, data: pd.DataFrame, weighting: bool = True, only_own_rec=False, log_quantity=False, agg_f='sum'):
        ...
        self.user_item_matrix = self._prepare_matrix(data, log_quantity, agg_f)
...
#             pass
    ...
    @staticmethod
    def _prepare_matrix(data: pd.DataFrame, log_quantity=False, agg_f='sum'):
    ...
    @staticmethod
    def fit(user_item_matrix, n_factors=20, regularization=0.001, iterations=15, num_threads=6):
        """Обучает ALS"""
...
#         return self.model.recommend_all()